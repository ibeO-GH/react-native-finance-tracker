...
A modern **personal finance tracking app** built with **React Native and Expo**.
The app allows users to record transactions, categorize expenses, visualize spending analytics, and manage their financial data with a clean mobile interface.
